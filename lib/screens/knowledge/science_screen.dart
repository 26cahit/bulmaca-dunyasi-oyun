...
class _ScienceScreenState extends State<ScienceScreen> {
  ...
  final List<Map<String, dynamic>> allQuestions = [
    ...
    },
    {
      ...
      'answers': ['Kalp', 'Karaciğer', 'Deri', 'Akciğer'],
      'correct': 2,
    },
    {
      'question': 'Dünya hangi yıldızın etrafında döner?',
      'answers': ['Ay', 'Güneş', 'Kutup Yıldızı', 'Sirius'],
      'correct': 1,
    },
    {
      'question': 'Bitkiler besin üretirken hangi olayı gerçekleştirir?',
      'answers': ['Solunum', 'Fotosentez', 'Sindirim', 'Buharlaşma'],
      'correct': 1,
    },
    {
      'question':
          'Yer çekimi ile ilgili çalışmalarıyla tanınan bilim insanı kimdir?',
      'answers': [
        'Albert Einstein',
        'Isaac Newton',
        'Nikola Tesla',
    ...
    },
    {
      ...
      'answers': ['Dünya', 'Mars', 'Satürn', 'Jüpiter'],
      'correct': 3,
    },
    {
      'question': 'Ses boşlukta yayılır mı?',
      'answers': ['Evet', 'Hayır', 'Sadece geceleri', 'Sadece yüksek seste'],
      'correct': 1,
    },
    {
    ...
    {
      'question': 'DNA\'nın temel görevi nedir?',
      'answers': [
        'Enerji üretmek',
  ...
  Future<void> _saveCurrentGame() async {
    await PlayerService.saveLastGame(gameType: 'knowledge', section: 'science');
  }
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    const Icon(Icons.science, color: Colors.amber, size: 48),
                    const SizedBox(height: 18),
                    Text(
