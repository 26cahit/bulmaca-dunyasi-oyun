...
class _GeographyScreenState extends State<GeographyScreen> {
  ...
  final List<Map<String, dynamic>> allQuestions = [
    ...
    },
    {
      ...
      'answers': ['Seul', 'Pekin', 'Tokyo', 'Bangkok'],
      'correct': 2,
    },
    {
      'question': 'Nil Nehri hangi kıtadadır?',
      'answers': ['Asya', 'Afrika', 'Avrupa', 'Güney Amerika'],
      'correct': 1,
    },
    {
      'question': 'Dünyanın en büyük kıtası hangisidir?',
      'answers': ['Afrika', 'Avrupa', 'Asya', 'Kuzey Amerika'],
      'correct': 2,
    },
    {
      'question': 'Fransa\'nın başkenti neresidir?',
      'answers': ['Roma', 'Madrid', 'Paris', 'Berlin'],
      'correct': 2,
    },
    {
      'question': 'Everest Dağı hangi sıradağlarda bulunur?',
      'answers': ['Alpler', 'And Dağları', 'Himalayalar', 'Toroslar'],
      'correct': 2,
    },
    {
      'question': 'Brezilya hangi kıtadadır?',
      'answers': ['Afrika', 'Asya', 'Güney Amerika', 'Avrupa'],
      'correct': 2,
    },
    {
      'question': 'Türkiye kaç kıta üzerinde yer alır?',
      'answers': ['1', '2', '3', '4'],
      'correct': 1,
    },
    {
      ...
      builder: (dialogContext) {
        ...
        return AlertDialog(
          ...
          content: Text(
            ...
            '$helpPrice jeton.\n\n'
            'Yardımı kullanırsan '
            '$remainingCoins jetonun kalacak.\n\n'
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    const Icon(Icons.public, color: Colors.amber, size: 48),
